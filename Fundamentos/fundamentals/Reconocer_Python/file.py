mi_nuevo_lenguaje_favorito = 'Python' # declaración variable, inicializar cadena

# - variable declaration, number initialized
num1 = 42 # variable declaration, decimal/float initialized
...
p# variable declaration, dictionary initialized
erson = {'name': 'John', 'location': 'Salt Lake', 'age': 37, 'is_balding': False}
